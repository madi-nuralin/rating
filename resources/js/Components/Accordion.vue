<template>
	<div class="relative">
		<button class="inline-flex w-full items-center justify-between py-2 font-semibold text-xs text-gray-700 uppercase tracking-widest hover:text-gray-500 focus:outline-none active:text-gray-800 active:bg-gray-50 disabled:opacity-25 transition" @click="collapse = ! collapse; $emit('collapsed', collapse)" :class="[triggerClass]">
		    ...
		    <button class="rounded-full inline-flex items-center justify-center border border-gray-300 rounded-md font-semibold text-xs text-gray-700 tracking-widest shadow-sm hover:text-gray-500 focus:outline-none focus:border-blue-300 focus:ring focus:ring-blue-200 active:text-gray-800 active:bg-gray-50 disabled:opacity-25 transition dark:border-gray-600 dark:bg-gray-600 dark:text-gray-100" :class="{'transform rotate-180 transition duration-500 ease-in-out': collapse}">
