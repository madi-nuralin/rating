        ...
        <template #form>
            <div class="col-span-6">
                <div class="max-w-xl text-sm text-gray-600">
                    {{ $t('pages.management.parameters.list.form.listInfo') }}
                </div>
            </div>
                
            <div class="relative z-0 mt-1 border border-gray-200 rounded-lg cursor-pointer col-span-6 sm:col-span-4">
                <button class="relative px-4 py-3 inline-flex w-full rounded-lg focus:z-10 focus:outline-none focus:border-blue-300 focus:ring focus:ring-blue-200" type="button" v-for="(parameter, i) in parameters" :key="parameter.id" :class="{'border-t border-gray-200 rounded-t-none': i > 0, 'rounded-b-none': i != Object.keys(parameters).length - 1}">
                    ...
                    <div class="w-full">
                        <div class="flex items-center justify-between">
                            ...
                            <Link 
                                ...
                                :href="route('parameter.show', {'id': parameter.id})">
