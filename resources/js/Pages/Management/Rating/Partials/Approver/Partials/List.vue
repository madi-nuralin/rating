    ...
    <BreezeFormSection>
        ...
        <template #form>
            <div class="col-span-6">
                <BreezeList :items="rating.approvers">
                    <template #item="{item}">
                        <div class="flex justify-between">
                            ...
                            <Link class="ml-2 text-sm text-gray-400 underline" :href="route('rating.approver.show', {'approver': item.id, 'rating': rating.id})">
