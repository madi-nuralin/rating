                        ...
                        <div class="-mx-6 overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
                                ...
                                <tr class="flex flex-col md:table-row" v-for="user in $page.props.verifier.users.data"
                                    v-if="$page.props.verifier && $page.props.verifier.users">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center space-x-2">
                                            <breeze-progress :color="'indigo'" :rounded="false"
                                                             :percentage="user.statistics.completed/user.statistics.total * 100"/>
                                            <p class="text-sm text-gray-500">{{ user.statistics.completed }} /
                                                {{ user.statistics.total }}</p>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <Link
                                            :href="route('verification.index', {'verifier': $page.props.verifier.id, 'rating': $page.props.verifier.rating.id, 'user': user.id})"
