                      ...
                      <div class="shadow md:rounded-lg border-gray-100 dark:bg-gray-900/70 bg-white border dark:border-gray-800">
                         ...
                         <div class="p-6">
                            <div class="justify-between items-center flex">
                               ...
                               <div class="flex shrink-0 grow-0 items-center justify-center">
                                  <span class="inline-flex justify-center items-center text-indigo-500">
                      ...
                      <div class="shadow md:rounded-lg border-gray-100 dark:bg-gray-900/70 bg-white border dark:border-gray-800">
                         ...
                         <div class="p-6">
                            <div class="justify-between items-center flex">
                               ...
                               <div class="flex shrink-0 grow-0 items-center justify-center">
                                  <span class="inline-flex justify-center items-center text-blue-500">
                      ...
                      <div class=" _px-4 pb-4 _sm:p-6 _sm:pb-4">
                        <div class="sm:flex sm:items-start">
                          ...
                          <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            <Link class="hover:underline" :href="route('submission.index', {'rating': rating.id})"  >
                              <h3 class="text-lg">
                                {{ rating.name}}
                              </h3>
                            </Link>
