                    ...
                    <div class="w-full">
                        <div class="flex items-center justify-between">
                            ...
                            <Link 
                                ...
                                :href="route(readonly ? 'activity.show' : 'activity.edit', {'id': activity.id})">
