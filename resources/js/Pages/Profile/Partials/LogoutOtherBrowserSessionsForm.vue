    ...
    <breeze-action-section>
        ...
        <template #content>
            ...
            <div class="flex items-center mt-5">
                ...
                <breeze-action-message :on="form.recentlySuccessful" class="ml-3">
                    Done.
                </breeze-action-message>
            </div>

            <!-- Log Out Other Devices Confirmation Modal -->
            <breeze-dialog-modal :show="confirmingLogout" @close="closeModal">
                <template #title>
                    Log Out Other Browser Sessions
                </template>
                ...
                <template #content>
                    ...
                    <div class="mt-4">
                        <breeze-input type="password" class="mt-1 block w-3/4" placeholder="Password"
                                    ref="password"
                                    v-model="form.password"
                                    @keyup.enter="logoutOtherBrowserSessions" />

                        <breeze-input-error :message="form.errors.password" class="mt-2" />
                    </div>
                </template>
                ...
                <template #footer>
                    ...
                    <breeze-button class="ml-2" @click="logoutOtherBrowserSessions" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                        Log Out Other Browser Sessions
                    </breeze-button>
                </template>
            </breeze-dialog-modal>
